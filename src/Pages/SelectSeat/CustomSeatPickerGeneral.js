...
const CustomSeatPickerGeneral = ({ layout, selectedSeats, onSelect, onDeselect, maxSeats, isReadOnly = false, onSeatClick = () => { } }) => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
            {layout.map((row, rowIndex) => {
                const sortedRow = [...row].sort((a, b) => b.number - a.number);
                return (
...
export default CustomSeatPickerGeneral;